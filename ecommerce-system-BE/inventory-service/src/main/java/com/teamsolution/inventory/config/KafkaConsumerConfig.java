...
public class KafkaConsumerConfig {
    ...
    public DefaultErrorHandler errorHandler(
            ...
            FailedEventSaverService failedEventService) {
        ...
        DeadLetterPublishingRecoverer recoverer =
                new DeadLetterPublishingRecoverer(
                        ...
                        (record, ex) -> {
                            failedEventService.saveFailedEvent(record, ex);

                            return new TopicPartition(
                                    record.topic() + kafkaConsumerProperties.getDlt()
                                            .getSuffix(),
                                    record.partition());
                        });
        ...
        backOff.setMaxAttempts(
                kafkaConsumerProperties.getRetry()
                        .getMaxKafkaRetry()); // maximum of retry attempts
